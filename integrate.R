...
##                   for Regional Coral Reef Red List of Ecosystems
##
##  Objective:     Analyse criteria and diagnostics for IUCN Red List of
##                   Ecosystems for coral reefs at regional levels and
##                   for individual Ecoregions (or other Area of Assessment)
##
...
##
##
##  Authors:       James Mbugua, Diana Karan, Abigail Mwalimu, Nimrod Ishmael,
...
##
 ...
 ## -- create ecoregional boundaries -- ##
  ...
  # create custom ecoregions
    source(paste0(creation_locale, "create_regional_ecoregions_custom.R"))
 ...
 ## -- create data object -- ##
  ...
  # create criterion a data table
    source(paste0(creation_locale,
                  "create_criterion_a_data_table_coral_cover.R"))
